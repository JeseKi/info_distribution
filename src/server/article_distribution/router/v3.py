# -*- coding: utf-8 -*-
"""API key routes for article distribution V3."""
...
from .. import service
from ..schemas import ArticleOut, ArticleV3BatchCreate, ArticleV3Update
from .shared import v3_router
...
async def create_articles_v3(
    ...
    def _create():
        ...
        return service.create_articles_with_api_key_v3(
...
async def update_article_v3(
    ...
    def _update():
        api_key = service.authenticate_api_key(db, x_api_key)
        return service.update_article_with_api_key_v3(
